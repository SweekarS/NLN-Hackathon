  ...
  return (
    <section id="product" className="landing-section surface-b">
      <div className="landing-container prose">
        ...
        />
        <p>
          We translate emotional support into small rituals: breathing, movement, social connection,
          focus, and evening wind-down tasks. Progress feels like growth, not judgment.
        </p>
        <p>
          During onboarding, Google Gemini turns user preferences into a personalized ritual plan. If
